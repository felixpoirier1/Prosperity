...
class Trader:
    def __init__(self) -> None:
        self.position = copy.deepcopy({'STARFRUIT':0, 'AMETHYSTS':0, 'ORCHIDS':0, 'GIFT_BASKET':0, 'CHOCOLATE':0, 'STRAWBERRIES':0, 'ROSES':0})

        self.cpnl = defaultdict(lambda : 0)
        self.sf_cache = []
        self.POSITION_LIMIT = {'STARFRUIT':20, 'AMETHYSTS':20, 'ORCHIDS':100, 'GIFT_BASKET':60, 'CHOCOLATE':250, 'STRAWBERRIES':350, 'ROSES':60}
