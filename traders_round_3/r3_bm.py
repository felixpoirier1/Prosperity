...
class Trader:
    ...
    def compute_orders_basket(self, order_depth: Dict[Symbol, OrderDepth]) -> Dict[Symbol, list[Order]]:
        ...
        res_buy = mid_price['GIFT_BASKET'] - mid_price['STRAWBERRIES'] * 6 - mid_price['CHOCOLATE'] * 4 - mid_price['ROSES'] - 400
        res_sell = mid_price['GIFT_BASKET'] - mid_price['STRAWBERRIES'] * 6 - mid_price['CHOCOLATE'] * 4 - mid_price['ROSES'] - 400
    ...
    def compute_etf_orders(self, order_depths: Dict[Symbol, OrderDepth], etf: OrderDepth, etf_components: Dict[Symbol, OrderDepth]) -> dict[Symbol, list[Order]]:
        etf_orders = self.compute_orders_basket(order_depths)
