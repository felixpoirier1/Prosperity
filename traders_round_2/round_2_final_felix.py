...
class Trader:
    ...
    def run(self, state: TradingState) -> tuple[dict[Symbol, list[Order]], int, str]:
        ...
        # FELIX CHANGE
        if len(self.past_orchids_prices) == 20:
            self.past_orchids_prices.pop(0)
        self.past_orchids_prices.append(orchid_observation.askPrice + orchid_observation.importTariff + orchid_observation.transportFees)
